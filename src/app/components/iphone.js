...
export default function Iphone({ title, text }) {
  const date = new Date();
  ...
  return (
    <div className="h-[712px] w-[350px] bg-black rounded-[60px] border-[14px] border-black relative overflow-hidden ring ring-[#00d1d3] shadow-xl">
      <img
